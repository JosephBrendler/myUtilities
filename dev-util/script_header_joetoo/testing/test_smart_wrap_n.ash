#!/bin/sh
# verbosity=${_verbosity} smart_wrap_n v0.2.0 test battery
...
do_test() {
  ...
  case "$_tc" in
    1 ) # test 1: far-right start (greedy wrap)
      ...
      message "parameters 35 $_indent $_indent"
      printf "\r"; CUF 35
    ...
    2 ) # test 2: fragment finish (short string)
      ...
      message "parameters 5 $_indent $_indent"
      printf "\r"; CUF 5
    ...
    3 ) # test 3: impossible word (emergency fallback)
      ...
      message "parameters 0 $_indent $_indent"
